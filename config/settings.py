...
# Conversational sender for staff SMS and customer replies. Falls back to
# TWILIO_PHONE_NUMBER when blank.
TWILIO_MESSAGING_PHONE_NUMBER = os.environ.get("TWILIO_MESSAGING_PHONE_NUMBER", "")
